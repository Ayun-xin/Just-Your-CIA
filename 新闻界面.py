...
class TextBrowserDemo(QMainWindow):
    def __init__(self):
        ...
        self.close_button.setStyleSheet(
            "background-color: rgba(0, 0, 0, 128); color: white; border-radius: 5px;")  # 设置按钮样式
    ...
    def displaytextfile(self, filepath):
        ...
        self.animation.setEndValue(QRect(2200, 0, self.width(), self.height()))
...
if __name__ == '__main__':
    ...
    demo.displaytextfile('./newsput.txt')
    demo.show()
    sys.exit(app.exec())
